...
| friction | float | "Slippyness" of the entity. Default = 1. lower values make them slide more, similar as they would stand on ice. Higher values make them slide less. A value of 0 makes them not able to move at all. |
| shadowSize | int ||
| stageHP | int ||
